...
if(pointcloud_to_rangeimage_CONFIG_INCLUDED)
  return()
endif()
set(pointcloud_to_rangeimage_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(pointcloud_to_rangeimage_SOURCE_PREFIX /home/cxl/workspace/lidar_slam_basic/ch2/pcl/src/pointcloud_to_rangeimage)
  set(pointcloud_to_rangeimage_DEVEL_PREFIX /home/cxl/workspace/lidar_slam_basic/ch2/pcl/devel)
  set(pointcloud_to_rangeimage_INSTALL_PREFIX "")
  set(pointcloud_to_rangeimage_PREFIX ${pointcloud_to_rangeimage_DEVEL_PREFIX})
else()
  set(pointcloud_to_rangeimage_SOURCE_PREFIX "")
  set(pointcloud_to_rangeimage_DEVEL_PREFIX "")
  set(pointcloud_to_rangeimage_INSTALL_PREFIX /home/cxl/workspace/lidar_slam_basic/ch2/pcl/install)
  set(pointcloud_to_rangeimage_PREFIX ${pointcloud_to_rangeimage_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'pointcloud_to_rangeimage' is deprecated")
...
set(pointcloud_to_rangeimage_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/cxl/workspace/lidar_slam_basic/ch2/pcl/devel/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(pointcloud_to_rangeimage_INCLUDE_DIRS "")
  set(_include_dirs "/home/cxl/workspace/lidar_slam_basic/ch2/pcl/devel/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${pointcloud_to_rangeimage_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pointcloud_to_rangeimage' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pointcloud_to_rangeimage' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cxl/workspace/lidar_slam_basic/ch2/pcl/src/pointcloud_to_rangeimage/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pointcloud_to_rangeimage_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND pointcloud_to_rangeimage_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND pointcloud_to_rangeimage_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT pointcloud_to_rangeimage_NUM_DUMMY_TARGETS)
      set(pointcloud_to_rangeimage_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pointcloud_to_rangeimage::wrapped-linker-option${pointcloud_to_rangeimage_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pointcloud_to_rangeimage_NUM_DUMMY_TARGETS "${pointcloud_to_rangeimage_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pointcloud_to_rangeimage::wrapped-linker-option${pointcloud_to_rangeimage_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pointcloud_to_rangeimage_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cxl/workspace/lidar_slam_basic/ch2/pcl/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(pointcloud_to_rangeimage_LIBRARY_DIRS ${lib_path})
      list(APPEND pointcloud_to_rangeimage_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'pointcloud_to_rangeimage'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND pointcloud_to_rangeimage_LIBRARIES ${lib})
    endif()
  endif()
...
set(pointcloud_to_rangeimage_EXPORTED_TARGETS "pointcloud_to_rangeimage_gencfg")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${pointcloud_to_rangeimage_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 pointcloud_to_rangeimage_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${pointcloud_to_rangeimage_dep}_FOUND)
      find_package(${pointcloud_to_rangeimage_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pointcloud_to_rangeimage_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(pointcloud_to_rangeimage_INCLUDE_DIRS ${${pointcloud_to_rangeimage_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(pointcloud_to_rangeimage_LIBRARIES ${pointcloud_to_rangeimage_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${pointcloud_to_rangeimage_dep}_LIBRARIES})
  _list_append_deduplicate(pointcloud_to_rangeimage_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(pointcloud_to_rangeimage_LIBRARIES ${pointcloud_to_rangeimage_LIBRARIES})

  _list_append_unique(pointcloud_to_rangeimage_LIBRARY_DIRS ${${pointcloud_to_rangeimage_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(pointcloud_to_rangeimage_EXPORTED_TARGETS ${${pointcloud_to_rangeimage_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${pointcloud_to_rangeimage_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
