...
if(bin2rosbag_CONFIG_INCLUDED)
  return()
endif()
set(bin2rosbag_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(bin2rosbag_SOURCE_PREFIX /home/cxl/slambook2/lidar_slam_basic/ch3/data_tran/src/bin2rosbag)
  set(bin2rosbag_DEVEL_PREFIX /home/cxl/slambook2/lidar_slam_basic/ch3/data_tran/devel)
  set(bin2rosbag_INSTALL_PREFIX "")
  set(bin2rosbag_PREFIX ${bin2rosbag_DEVEL_PREFIX})
else()
  set(bin2rosbag_SOURCE_PREFIX "")
  set(bin2rosbag_DEVEL_PREFIX "")
  set(bin2rosbag_INSTALL_PREFIX /home/cxl/slambook2/lidar_slam_basic/ch3/data_tran/install)
  set(bin2rosbag_PREFIX ${bin2rosbag_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'bin2rosbag' is deprecated")
...
set(bin2rosbag_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/local/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/local/include/opencv4 " STREQUAL " ")
  set(bin2rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/usr/local/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND bin2rosbag_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cxl/slambook2/lidar_slam_basic/ch3/data_tran/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(bin2rosbag_LIBRARY_DIRS ${lib_path})
      list(APPEND bin2rosbag_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'bin2rosbag'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND bin2rosbag_LIBRARIES ${lib})
    endif()
  endif()
...
set(bin2rosbag_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${bin2rosbag_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 bin2rosbag_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${bin2rosbag_dep}_FOUND)
      find_package(${bin2rosbag_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bin2rosbag_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(bin2rosbag_INCLUDE_DIRS ${${bin2rosbag_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(bin2rosbag_LIBRARIES ${bin2rosbag_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${bin2rosbag_dep}_LIBRARIES})
  _list_append_deduplicate(bin2rosbag_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(bin2rosbag_LIBRARIES ${bin2rosbag_LIBRARIES})

  _list_append_unique(bin2rosbag_LIBRARY_DIRS ${${bin2rosbag_dep}_LIBRARY_DIRS})
  list(APPEND bin2rosbag_EXPORTED_TARGETS ${${bin2rosbag_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${bin2rosbag_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
